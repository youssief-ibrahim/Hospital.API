        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Billings_Accountants_AccountantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Inpatient_AdmissionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Inpatient_Admissions", x => x.Inpatient_AdmissionId);
                    table.ForeignKey(
                        name: "FK_Inpatient_Admissions_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Inpatient_Admissions_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Inpatient_Admissions_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Inpatient_Admissions_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inpatient_Admissions_DepartmentId",
                table: "Inpatient_Admissions",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Inpatient_Admissions_DoctorId",
                table: "Inpatient_Admissions",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_Inpatient_Admissions_PatientId",
                table: "Inpatient_Admissions",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_Inpatient_Admissions_RoomId",
                table: "Inpatient_Admissions",
                column: "RoomId");
